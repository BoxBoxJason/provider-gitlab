...
const (
	...
	errMissingConnectionSecret = "writeConnectionSecretToRef or publishConnectionDetailsTo must be specified to receive the license key"
	...
	keyEndpointUsername = "endpoint_username"
	keyEndpointPassword = "endpoint_password"
	keyEndpointToken    = "endpoint_token"
)
